...
[![Fetch Status](https://github.com/mkmkgo/AutoMergePublicNodes/actions/workflows/fetch.yml/badge.svg)](https://github.com/mkmkgo/AutoMergePublicNodes/actions/workflows/fetch.yml) [![Stars](https://img.shields.io/github/stars/mkmkgo/AutoMergePublicNodes?style=flat)](https://github.com/mkmkgo/AutoMergePublicNodes/stargazers) [![Watchers](https://img.shields.io/github/watchers/mkmkgo/AutoMergePublicNodes?style=flat)](https://github.com/mkmkgo/AutoMergePublicNodes/watchers) [![Forks](https://img.shields.io/github/forks/mkmkgo/AutoMergePublicNodes?style=flat)](https://github.com/mkmkgo/AutoMergePublicNodes/forks) [![Repo size](https://img.shields.io/github/repo-size/mkmkgo/AutoMergePublicNodes)](https://github.com/mkmkgo/AutoMergePublicNodes/commits) ![Vistors](https://visitor-badge.laobi.icu/badge?page_id=peasoft.NoMoreWalls) [![996.icu](https://img.shields.io/badge/link-996.icu-red.svg)](https://996.icu) [![LICENSE](https://img.shields.io/badge/license-Anti%20996-blue.svg)](https://github.com/mkmkgo/AutoMergePublicNodes/blob/master/LICENSE.md) [![暮光计划](https://img.shields.io/badge/link-暮光计划--向戒网瘾学校宣战-red.svg)](https://proj3ctaurora.tilda.ws/)
...
添加 Base64 订阅：
- [原始链接](https://raw.githubusercontent.com/mkmkgo/AutoMergePublicNodes/master/list.txt)
- [GhProxy.cn](https://ghproxy.cn/https://raw.githubusercontent.com/mkmkgo/AutoMergePublicNodes/master/list.txt)
- 此处不公开部分私有镜像站

以下链接可能不是最新，但绝对不会被封：
- [JsDelivr 默认 (当前 Fastly)](https://cdn.jsdelivr.net/gh/mkmkgo/AutoMergePublicNodes@master/list.txt)
- [JsDelivr Fastly CDN](https://fastly.jsdelivr.net/gh/mkmkgo/AutoMergePublicNodes@master/list.txt)
- [JsDelivr Cloudflare CDN](https://testingcf.jsdelivr.net/gh/mkmkgo/AutoMergePublicNodes@master/list.txt)
- [JsDelivr GCore CDN](https://gcore.jsdelivr.net/gh/mkmkgo/AutoMergePublicNodes@master/list.txt)

或添加 Clash Meta 订阅：（如果使用的是原版 Clash，请将链接最后的 `.meta.yml` 替换成 `.yml`。如果 Meta 提示解析错误，请**更新 Meta 至最新版本**！）
- [原始链接](https://raw.githubusercontent.com/mkmkgo/AutoMergePublicNodes/master/list.meta.yml)
- [GhProxy.cn](https://ghproxy.cn/https://raw.githubusercontent.com/mkmkgo/AutoMergePublicNodes/master/list.meta.yml)
- 此处不公开部分私有镜像站

以下链接可能不是最新，但绝对不会被封：
- [JsDelivr 默认 (当前 Fastly)](https://cdn.jsdelivr.net/gh/mkmkgo/AutoMergePublicNodes@master/list.meta.yml)
- [JsDelivr Fastly CDN](https://fastly.jsdelivr.net/gh/mkmkgo/AutoMergePublicNodes@master/list.meta.yml)
- [JsDelivr Cloudflare CDN](https://testingcf.jsdelivr.net/gh/mkmkgo/AutoMergePublicNodes@master/list.meta.yml)
- [JsDelivr GCore CDN](https://gcore.jsdelivr.net/gh/mkmkgo/AutoMergePublicNodes@master/list.meta.yml)
...
1. 克隆本仓库，由于本仓库的完整 Commit 历史极大，请务必指定 `--depth=1`：
    ```bash
    git clone https://github.com/mkmkgo/AutoMergePublicNodes.git --depth=1
    ```
2. 安装依赖库（此步骤需要 Git）
    ```bash
...
<a href="https://star-history.com/#mkmkgo/AutoMergePublicNodes">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=mkmkgo/AutoMergePublicNodes&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=mkmkgo/AutoMergePublicNodes" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=mkmkgo/AutoMergePublicNodes" />
  </picture>
</a>
